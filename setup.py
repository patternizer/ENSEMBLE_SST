...
setup(
    ...
    description='Library and scripts for generation of timeseries of AVHRR noise parameters and conversion of original data in ASCII format to compressed netCDF',
